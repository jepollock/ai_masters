...
for i in \
	...
	fwd_iat.tot fwd_iat.avg fwd_iat.std bwd_iat.min bwd_iat.max \
	bwd_iat.tot bwd_iat.avg bwd_iat.std flow_iat.min flow_iat.max \
...
echo "StructField(\"Attack_type\", StringType())"
