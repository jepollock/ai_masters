...
Spark is not an appropriate tool to explore model options. It isn't possible to quickly iterate, the algorithmic support isn't there (I had to implement TargetEncoder for multiple class support) and clusters are slower and less capable than current consumer hardware.
