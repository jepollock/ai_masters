...
All steps were completed. Step 4+ do not currently run on the lab cuda machines.

\section{How to Setup}

I use the GloVe embeddings. To set up the environment:
...
\subsection{CNN with Pre-trained Embedding}
